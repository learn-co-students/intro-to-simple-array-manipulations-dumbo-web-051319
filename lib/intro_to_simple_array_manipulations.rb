...
def using_unshift(neighborhoods_in_northwest_brooklyn, newString)
newString = "Brooklyn Heights"
neighborhoods_in_northwest_brooklyn.unshift(newString)
end
...
def using_delete(instructors, deleteItem)
  deleteItem = "Steven"
  no_offense_steven = instructors.delete(deleteItem)
end
